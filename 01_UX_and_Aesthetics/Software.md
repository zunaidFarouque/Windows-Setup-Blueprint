...
| **WinMerge**                    | UniGetUI                                      | Compare and merge files/folders.           |
...
| **ContextMenuManager**              | UniGetUI (D)                                                                          | Clean and speed up right-click menu.                       |
| **Easy Context Menu**               | UniGetUI (D)                                                                          | Quick context menu toggles.                                |
...
| **Kando**                           | UniGetUI (D)                                                                          | Radial launcher menu.                                      |
| **Custom Resolution Utility (CRU)** | [Manual (D)](https://customresolutionutility.net/#download-custom-resolution-utility) | Fix/override display modes when EDID is wrong.             |
